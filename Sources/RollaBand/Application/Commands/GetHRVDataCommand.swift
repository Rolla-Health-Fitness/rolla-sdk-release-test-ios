...
public enum HRVCommandType: UInt8, RollaBandReadCommandType {
    case readRecent = 0x00
    case continueReading = 0x02
}

public struct GetHRVDataCommand: RollaBandDataCommand {
    public typealias CommandType = HRVCommandType
    public typealias Output = Void
    
    public let deviceUUID: BLEDeviceIdentifier
    public let timeout: TimeInterval
    public let commandType: HRVCommandType
    ...
    private func buildCommand() -> Data {
        ...
        bytes[0] = RollaBandCommand.getHRVData.rawValue
