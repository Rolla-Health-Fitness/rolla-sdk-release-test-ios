...
public enum SleepDataCommandType: UInt8, RollaBandReadCommandType {
    case readRecent = 0x00
    case continueReading = 0x02
}

public struct GetSleepDataCommand: RollaBandDataCommand {
    public typealias CommandType = SleepDataCommandType
    public typealias Output = Void

    public let deviceUUID: BLEDeviceIdentifier
    public let timeout: TimeInterval
    public let commandType: SleepDataCommandType
    ...
    private func buildCommand() -> Data {
        ...
        bytes[0] = RollaBandCommand.getSleepData.rawValue
