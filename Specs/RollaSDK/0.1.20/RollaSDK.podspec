...
Pod::Spec.new do |s|
  ...
  s.source           = {
    :http => 'https://github.com/Rolla-Health-Fitness/rolla-sdk-release-test-ios/releases/download/0.1.20-test/RollaSDK-iOS-0.1.20.zip'
  }
  ...
  s.vendored_frameworks = [
    ...
    'flutter_secure_storage_darwin.xcframework',
