...
Pod::Spec.new do |s|
  ...
  s.source           = {
    :http => 'https://github.com/Rolla-Health-Fitness/rolla-sdk-release-test-ios/releases/download/0.1.16-test.270.1/RollaSDK-iOS-0.1.16-test.270.1.zip'
  }
